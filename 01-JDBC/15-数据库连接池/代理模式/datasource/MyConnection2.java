...
public class MyConnection2 implements Connection {
	...
	private int nowUseCount = 0;
	
	MyConnection2(Connection realConnection, MyDataSource2 myDataSource) {
	...
	public void close() throws SQLException {
		...
		System.out.println("MyConnection2的close()方法");
		this.nowUseCount++;
		if (nowUseCount < maxUseCount) {
			this.myDataSource.connectionsPool.addLast(this);
		} else {
			this.realConnection.close();	//超过使用次数不放回池中
			System.out.println("销毁一个Connection");
		}
		this.myDataSource.CURRENT_CONNECTIONS--;
	}
